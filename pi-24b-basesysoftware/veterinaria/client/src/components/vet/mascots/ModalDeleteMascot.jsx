...
const ModalDeleteMascot = ({ open,onClose, mascot_p, handleModificationSuccess}) => {
  ...
  const handleUpdate = async () => {
    try {
      ...
      await axiosInstance.put("http://localhost:8080/veterinarios/mascotas/delete", mascot);
                ...
                >
                    ...
                    <Box display="flex" justifyContent="space-between" alignItems="center">
                        <Typography variant="h6" component="h2">
                          <strong> {mascot.ESTADO == 1? "Deshabilitar Mascota": "Habilitar Mascota"}</strong>
                        </Typography>
                        ...
                        <Typography id="modal-modal-title"  paddingTop={4}>
