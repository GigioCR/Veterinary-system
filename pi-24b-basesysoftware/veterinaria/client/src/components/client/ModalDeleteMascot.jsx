...
const ModalDeleteMascot = ({ open,onClose, mascot_p, handleModificationSuccess}) => {
  ...
  const handleUpdate = async () => {
    try {
      ...
      await axiosInstance.put("http://localhost:8080/clientes/mascotas/delete", mascot);
    ...
    <div>
                ...
                >
                    ...
                    <Typography variant="h6">
                      Confirmar { mascot.ESTADO === 1 ? 'Eliminar' : 'Habilitar'}
                    </Typography>
                        ...
                        {mascot.ESTADO == 1? "¿Seguro que quiere eliminar a la mascota?":"¿Seguro que quiere habilitar a la mascota?"}
                        </Typography>
